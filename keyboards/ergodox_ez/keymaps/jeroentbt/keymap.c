 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   M    | BSPC |   A  |   S  |   D  |   F  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------|  B   |           | Meh  |------+------+------+------+------+--------|
 * | LCtrl  | LSft |   Z  |   X  |   C  |   V  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Rrv  |  '"  |      |  TAB | LCtrl|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  R   |  1   |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_M  ,   KC_BSPC,     KC_A,          KC_S,    KC_D,    KC_F,                                        KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), GUI_T(KC_QUOT),
  KC_LCTL,  KC_LSFT,     KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,                 MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  KC_GRV ,  KC_QUOT,     KC_F1,         KC_TAB,  KC_LCTL,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
