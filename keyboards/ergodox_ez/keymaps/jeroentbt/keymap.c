 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | ESC    |  TAB |   Q  |   W  |   E  |   R  |  T   |           |  L1  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   M    | LSft |   A  |   S  |   D  |   F  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------|  B   |           | Meh  |------+------+------+------+------+--------|
 * | LCtrl  | LSft |   Z  |   X  |   C  |   V  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Gui  | LCtl |      |  TAB | LCtrl|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  R   |  1   |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_ESC,   KC_TAB,      KC_Q,          KC_W,    KC_E,    KC_R,    KC_T,                 TG(SYMB),     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           KC_BSLS,
  KC_M  ,   KC_LSFT,     KC_A,          KC_S,    KC_D,    KC_F,                                        KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), GUI_T(KC_QUOT),
  KC_LCTL,  KC_LSFT,     KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,                 MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  KC_LGUI,  KC_LCTL,     KC_F1,         KC_TAB,  KC_LCTL,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
                                                                    KC_R, KC_1,               KC_LALT, CTL_T(KC_ESC),
                                                                          KC_3,               KC_PGUP,
                                                            KC_SPC, KC_E, KC_E,                  KC_PGDN, KC_TAB, KC_ENT
),
